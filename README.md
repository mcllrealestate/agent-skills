...
**AI agent skills for [MCLL Real Estate](https://mcllrealestate.com) — Thai residences, for sale and rent**
...
Search and retrieve published [MCLL](https://mcllrealestate.com) listings, residences for sale and rent across Bangkok, Phuket, and the islands. Three access methods, one published source; an agent uses whichever its runtime supports.
...
- **Markdown** — send `Accept: text/markdown` to any listing, area, news, or development URL for a clean text rendition.
